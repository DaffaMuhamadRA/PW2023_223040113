    ...
    <div class="container-fluid d-flex justify-content-center ">
        <form action="" method="post" style="width: 1000px;" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea type="text" class="form-control" id="indikasi_umum" rows="3" name="indikasi_umum"></textarea>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea type="text" class="form-control" id="aturan_pakai" rows="3" name="aturan_pakai"></textarea>
            </div>
            <div class="mb-3">
                <label for="perhatian" class="form-label">Perhatian</label>
                <textarea type="text" class="form-control" id="perhatian" rows="3" name="perhatian"></textarea>
            </div>
            <div class="mb-3">
                <label for="kontra_indikasi" class="form-label">Kontra Indikasi</label>
                <textarea type="text" class="form-control" id="kontra_indikasi" rows="3" name="kontra_indikasi"></textarea>
            </div>
            <div class="mb-3">
                <label for="efek_samping" class="form-label">Efek Samping</label>
                <textarea type="text" class="form-control" id="efek_samping" rows="3" name="efek_samping"></textarea>
            </div>
            <div class="mb-3">
                <label for="golongan_produk" class="form-label">Golongan Produk</label>
                <textarea type="text" class="form-control" id="golongan_produk" rows="3" name="golongan_produk"></textarea>
            </div>
            <div class="mb-3">
                <label for="kemasan" class="form-label">Kemasan</label>
                <textarea type="text" class="form-control" id="kemasan" rows="3" name="kemasan"></textarea>
            </div>
            <div class="mb-3">
                <label for="manufaktur" class="form-label">Manufaktur</label>
                <input type="text" class="form-control" id="manufaktur" rows="3" name="manufaktur"></textarea>
            </div>
            <div class="mb-3">
                <label for="no_registrasi" class="form-label">No Registrasi</label>
                <input type="text" class="form-control" id="no_registrasi" rows="3" name="no_registrasi"></textarea>
            </div>
            <div class="mb-3">
                <label for="kategori_obat" class="form-label">Kategori Obat</label>
                <input type="text" class="form-control" id="kategori_obat" name="kategori_obat">
            </div>
