...
<div class="row">
  ...
  <input type="search" class="form-control" placeholder="Search-bar"  id="keyword" name="keyword" autocomplete="off" autofocus>
  <button class="btn btn-primary" type="submit" id="btn-search" name="btn-search">Search</button>
  </form>
</div>
</div>
</div>
